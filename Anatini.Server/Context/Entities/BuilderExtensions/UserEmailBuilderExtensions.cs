...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class UserEmailBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ApplicationUserEmail> userEmailBuilder)
        {
            ...
            userEmailBuilder.Property(userEmail => userEmail.Email)!.Has(maxLength: 255, order: 2);
            userEmailBuilder.Property(userEmail => userEmail.ConfirmationCode).Has(maxLength: 255, order: 3);
            userEmailBuilder.Property(userEmail => userEmail.EmailConfirmed).Has(order: 4);
            userEmailBuilder.Property(userEmail => userEmail.NormalizedEmail)!.Has(maxLength: 255, order: 5);
