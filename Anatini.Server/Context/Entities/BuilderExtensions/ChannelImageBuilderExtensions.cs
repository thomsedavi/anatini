...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class ChannelImageBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ChannelImage> channelImageBuilder)
        {
            ...
            channelImageBuilder.HasKey(channelImage => new { channelImage.ChannelId, channelImage.Handle });

            channelImageBuilder.Property(channelImage => channelImage.ChannelId).Has(order: 0);
            channelImageBuilder.Property(channelImage => channelImage.Handle)!.Has(maxLength: 256, order: 1);
