...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class ContentImageBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ContentImage> contentImageBuilder)
        {
            ...
            contentImageBuilder.HasOneWithMany(contentImage => contentImage.Content, activity => activity.Images, contentImage => contentImage.ContentId, DeleteBehavior.Restrict);
        }
    }
}
