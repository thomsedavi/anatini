...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class UserPostEdgeBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ApplicationUserPostEdge> userPostEdgeBuilder)
        {
            ...
            userPostEdgeBuilder.HasOneWithMany(userPostEdge => userPostEdge.TargetPost, activity => activity.UserEdges, userPostEdge => userPostEdge.TargetPostId, DeleteBehavior.Restrict);
