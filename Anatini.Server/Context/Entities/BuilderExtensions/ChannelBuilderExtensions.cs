...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class ChannelBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<Channel> channelBuilder)
        {
            ...
            channelBuilder.Property(channel => channel.IconImageId).Has(order: 5);
            channelBuilder.Property(channel => channel.BannerImageId).Has(order: 6);
            channelBuilder.Property(channel => channel.DefaultCardImageId).Has(order: 7);
            channelBuilder.Property(channel => channel.NormalizedHandle)!.Has(maxLength: 256, order: 8);
