...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class NoteBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<Note> noteBuilder)
        {
            ...
            noteBuilder.Property(note => note.DateTimeNZ).Has(order: 4);
            ...
            noteBuilder.HasIndex(note => note.DateTimeNZ);
            noteBuilder.HasIndex(note => new { note.ChannelId, note.DateTimeNZ });
