...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class ContentVersionBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ContentVersion> contentVersionBuilder)
        {
            ...
            contentVersionBuilder.HasOneWithMany(contentVersion => contentVersion.Content, activity => activity.Versions, contentVersion => contentVersion.ContentId, DeleteBehavior.Cascade);
        }
    }
}
