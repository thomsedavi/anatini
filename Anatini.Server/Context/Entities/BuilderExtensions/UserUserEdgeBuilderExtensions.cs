...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class UserUserEdgeBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ApplicationUserUserEdge> userUserEdgeBuilder)
        {
            ...
            userUserEdgeBuilder.HasKey(userUserEdge => new { userUserEdge.SourceUserId, userUserEdge.TargetUserId });
            ...
            userUserEdgeBuilder.HasIndex(userUserEdge => new { userUserEdge.SourceUserId, userUserEdge.TargetUserId, userUserEdge.Label }).IsUnique();
