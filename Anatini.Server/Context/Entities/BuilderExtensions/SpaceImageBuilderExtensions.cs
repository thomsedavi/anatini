...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class SpaceImageBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<SpaceImage> spaceImageBuilder)
        {
            ...
            spaceImageBuilder.Property(spaceImage => spaceImage.Handle)!.Has(maxLength: 255, order: 1);
            spaceImageBuilder.Property(spaceImage => spaceImage.BlobName)!.Has(maxLength: 255, order: 2);
            spaceImageBuilder.Property(spaceImage => spaceImage.BlobContainerName)!.Has(maxLength: 255, order: 3);
            spaceImageBuilder.Property(spaceImage => spaceImage.AltText).Has(maxLength: 511, order: 4);
