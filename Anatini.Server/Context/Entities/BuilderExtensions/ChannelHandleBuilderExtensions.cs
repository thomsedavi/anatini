...
namespace Anatini.Server.Context.Entities.BuilderExtensions
{
    public static class ChannelHandleBuilderExtensions
    {
        public static void Configure(this EntityTypeBuilder<ChannelHandle> channelHandleBuilder)
        {
            ...
            channelHandleBuilder.Property(channelHandle => channelHandle.Handle).HasMaxLength(256);
            channelHandleBuilder.Property(channelHandle => channelHandle.NormalizedHandle).HasMaxLength(256);
            channelHandleBuilder.Property(channelHandle => channelHandle.CreatedAtUtc).HasColumnType("timestamp with time zone");
