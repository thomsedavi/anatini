    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                    blob_container_name = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "user_to_user_relationships",
                columns: table => new
                {
                    id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_to_user_relationships", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_user_aliases", x => x.id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_aliases_normalized_handle",
                table: "user_aliases",
                column: "normalized_handle",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_user_aliases_user_id_is_default",
                table: "user_aliases",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_user_emails_user_id_is_default",
                table: "user_emails",
                columns: new[] { "user_id", "is_default" },
                unique: true,
                filter: "is_default = true");
